            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                ...
                builder: (context) => ArticleDetail(
                    title: this
                        .title, //Now add this before all the parameters because we want the parameters which we get to specific tile Ok?
                    description: this.description,
                    imgUrl: this.imgUrl,
                    articleUrl: this.articleUrl,
                    content: this
                        .content), //Separated it to look good Do until here done?? //Now enter our screen name and pass the parameters
